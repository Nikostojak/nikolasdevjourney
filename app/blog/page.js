    ...
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f9f9f9', fontFamily: "'Poppins', Arial, sans-serif" }}>
      ...
      <section style={{ flex: 1, padding: '3rem 1.5rem', maxWidth: '800px', margin: '0 auto', color: '#333' }}>
        ...
        <p style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
          Welcome to my blog! Here you&rsquo;ll find tutorials, reflections, and updates from my journey as a self-taught developer.
          I&rsquo;ll be sharing what I learn as I go — from Python experiments to web development challenges.
        </p>
      </section>
