      ...
      <Container>
        ...
        >
          ...
          <div style={{ backgroundColor: '#2d3748', padding: '1.5rem', borderRadius: '8px' }}>
            ...
            <h2 style={{ fontSize: '1.8rem', margin: '1.5rem 0 1rem', color: '#edf2f7' }}>🗂️ Folder Structure</h2>
            <div
              style={{
                background: '#1a202c',
                padding: '1rem',
...
page.js`}
            ...
            <h2 style={{ fontSize: '1.8rem', margin: '1.5rem 0 1rem', color: '#edf2f7' }}>🎨 Styling & Design</h2>
            <p style={{ marginBottom: '1rem' }}>
            ...
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
              ...
              <li>Fonts are loaded via <a href="https://nextjs.org/docs/app/building-your-application/optimizing/fonts" target="_blank" rel="noopener noreferrer" style={{ color: '#63b3ed', textDecoration: 'none', ':hover': { color: '#90cdf4' } }}>next/font</a>, using <strong>Inter</strong>.</li>
              <li>Backgrounds, spacing, and alignment are all responsive and visually balanced.</li>
            </ul>

            <h2 style={{ fontSize: '1.8rem', margin: '1.5rem 0 1rem', color: '#edf2f7' }}>🚀 Deployment to Vercel</h2>
            <p style={{ marginBottom: '1rem' }}>
            ...
            <ol style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
              ...
              <li>Custom domain set up: <a href="https://nikolasdevjourney.com" target="_blank" rel="noopener noreferrer" style={{ color: '#63b3ed', textDecoration: 'none', ':hover': { color: '#90cdf4' } }}>nikolasdevjourney.com</a></li>
            </ol>

            <h2 style={{ fontSize: '1.8rem', margin: '1.5rem 0 1rem', color: '#edf2f7' }}>🔗 Connecting Frontend and Backend</h2>
            <p style={{ marginBottom: '1rem' }}>
            ...
            <h2 style={{ fontSize: '1.8rem', margin: '1.5rem 0 1rem', color: '#edf2f7' }}>📌 Lessons Learned</h2>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
